...
pub struct SecurityConfig {
    ...
    /// Allow SASL PLAIN authentication over non-TLS connections.
    /// WARNING: This is insecure and should only be used for testing or with an external TLS terminator.
    #[serde(default)]
