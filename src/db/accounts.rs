...
mod tests {
    ...
    async fn test_hash_password_produces_valid_argon2_hash() {
        ...
        let hash: String = hash_password(password.to_string())
            .await
    ...
    async fn test_hash_password_produces_unique_hashes() {
        ...
        let hash1: String = hash_password(password.to_string()).await.expect("first hash");
        let hash2: String = hash_password(password.to_string()).await.expect("second hash");
    ...
    async fn test_verify_password_correct() {
        ...
        let hash: String = hash_password(password.to_string()).await.expect("hashing");

        assert!(
            verify_password(password.to_string(), hash).await.expect("verify failed"),
    ...
    async fn test_verify_password_incorrect() {
        ...
        assert!(
            !verify_password(wrong_password.to_string(), hash).await.expect("verify failed"),
    ...
    async fn test_verify_password_empty_password() {
        ...
        assert!(
            verify_password(password.to_string(), hash.clone()).await.expect("verify failed"),
            "empty password should verify against its own hash"
        );
        assert!(
            !verify_password("nonempty".to_string(), hash).await.expect("verify failed"),
    ...
    async fn test_verify_password_invalid_hash_format() {
        let result: Result<bool, _> = verify_password("password".to_string(), "not_a_valid_hash".to_string()).await;
    ...
    async fn test_hash_password_unicode() {
        ...
        let hash: String = hash_password(password.to_string()).await.expect("unicode should hash");
    ...
    async fn test_hash_password_very_long() {
        ...
        let hash: String = hash_password(password.clone())
            .await
            .expect("long password should hash");

        assert!(
            verify_password(password, hash).await.expect("verify failed"),
