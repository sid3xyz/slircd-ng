...
//!
//! **Modular Architecture**: Spam detection as independent service
//! Separated from AntiAbuseService for clean separation of concerns.
//!
...
//! - **UnrealIRCd**: spamfilter module with regex patterns (src/modules/spamfilter.c)
//! - **InspIRCd**: m_spanningtree.cpp with spam detection hooks
//! - **Ergo**: Limited spam detection (relies on rate limits)
//! - **Solanum**: Basic pattern matching in channel modes
//!
//! **Our Approach**: Multi-layer detection with configurable thresholds
//! Verified: 2025-10-13
//!
//! # Design Principles
//! 1. **Low false positives**: Prefer under-detection to blocking legitimate users
//! 2. **Performance**: Hot path optimizations, cached regex compilation
//! 3. **Configurability**: Thresholds tunable via config (future)
//! 4. **Extensibility**: Easy to add new detection mechanisms
...
/// Designed to be called from AntiAbuseService.check_message()
