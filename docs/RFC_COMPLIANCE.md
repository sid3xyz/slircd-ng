...
- [ ] Message parsing (512 byte limit, CRLF, 15 params)
- [ ] Message tags support (4096 byte limit with tags)
- [ ] Nickname validation (format, length, uniqueness)
- [ ] Channel name validation (format, length, types)
...
- [ ] PASS command
- [ ] NICK command (pre and post registration)
- [ ] USER command
- [ ] Welcome burst (001-005)
- [ ] MOTD (375/372/376 or 422)
- [ ] CAP negotiation
...
- [ ] JOIN (single, multiple, with keys)
- [ ] JOIN 0 (leave all)
- [ ] PART (single, multiple, with message)
- [ ] TOPIC (view, set, restrictions)
- [ ] NAMES (single, multiple, all)
- [ ] LIST (all, filtered, ELIST)
- [ ] INVITE (with +i enforcement)
- [ ] KICK (with comment)
...
- [ ] Message tags parsing/generation
- [ ] Batch support
